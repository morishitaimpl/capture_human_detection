...
train_loader = DataLoader(train_dataset, batch_size=cf.batchSize, shuffle=True, num_workers=0, collate_fn=ld.collate_fn)
val_loader = DataLoader(val_dataset, batch_size=1, shuffle=False, num_workers=0, collate_fn=ld.collate_fn)
